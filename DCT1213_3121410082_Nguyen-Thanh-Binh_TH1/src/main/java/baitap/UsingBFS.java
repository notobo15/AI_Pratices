    ...
    public class UsingBFS {
        ...
        public static Queue<Cross> queue = new LinkedList<>();
        ...
        public static void main(String[] args) {
            ...
            System.out.println("- - - - - - - - - - - THUAT TOAN BFS - - - - - - - - - - -");
            ...
            while (!queue.isEmpty()) {
                ...
                // System.out.println("Cac Trang Thai Hop Le : " + newCrosses);
